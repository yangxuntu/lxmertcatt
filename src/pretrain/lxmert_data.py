...
Split2ImgFeatPath = {
    'mscoco_train': 'data/mscoco_imgfeat/train2014_obj64.tsv',
    'mscoco_minival': 'data/mscoco_imgfeat/val2014_obj64.tsv',
    'mscoco_nominival': 'data/mscoco_imgfeat/val2014_obj64.tsv',
    'vgnococo': 'data/vg_gqa_imgfeat/vg_gqa_obj64.tsv',
}
